...
// import PhoneVerificationPage from './pages/PhoneVerificationPage'; // لم يعد مطلوباً
...
function App() {
  ...
  // Protected route component that requires authentication فقط
...
// يجب لف App بـ Router في src/main.tsx أو index.tsx هكذا:
// <Router>
//   <App />
// </Router>
