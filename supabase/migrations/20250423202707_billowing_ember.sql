/*
  # إصلاح مشكلة جلسة المصادقة وسياسات الأمان
  
  1. التغييرات
    - تحديث سياسات الأمان لجدول profiles
    - إضافة سياسة تسمح للمستخدمين غير المسجلين بإنشاء ملفات شخصية
    - إضافة سياسة تسمح لدور الخدمة بإدارة جميع الملفات الشخصية
...
-- السماح للجميع بإنشاء ملفات شخصية (للتسجيل الأولي)
